...
<title> Music Store DH</title>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/Log-In.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('css/Sing-in.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/perfilDeUsuario.css')}}">
